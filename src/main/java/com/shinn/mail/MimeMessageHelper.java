...
public class MimeMessageHelper {
   ...
   * <p>
   * This was Spring 1.0's default behavior. It is known to work properly on Outlook. However, other
   * mail clients tend to misinterpret inline elements as attachments and/or show attachments inline
   * as well.
   */
   ...
   * Texts, inline elements and attachements will all get added to that root element.
   * <p>
   * This was the default behavior from Spring 1.1 up to 1.2 final. This is the "Microsoft multipart
   * mode", as natively sent by Outlook. It is known to work properly on Outlook, Outlook Express,
   * Yahoo Mail, and to a large degree also on Mac Mail (with an additional attachment listed for an
   * inline element, despite the inline element also shown inline). Does not work properly on Lotus
   * Notes (attachments won't be shown there).
   */
   ...
   * <p>
   * This is the default since Spring 1.2.1. This is arguably the most correct MIME structure,
   ...
   * <p>
   * The character encoding for the message will be taken from the passed-in MimeMessage object, if
   * carried there. Else, JavaMail's default encoding will be used.
   * 
  ...
  public MimeMessageHelper(MimeMessage mimeMessage) {
    this(mimeMessage, DEFAULT_ENCODING);
  }
   ...
   * <p>
   * Consider using the MimeMessageHelper constructor that takes a multipartMode argument to choose
   * a specific multipart mode other than MULTIPART_MODE_MIXED_RELATED.
   * <p>
   * The character encoding for the message will be taken from the passed-in MimeMessage object, if
   * carried there. Else, JavaMail's default encoding will be used.
   * 
   ...
   * <p>
   * By default, the root MimeMultipart element will be of type "mixed" (MULTIPART_MODE_MIXED) or
   ...
   *        <code>null</code> to indicate no multipart at all
   ...
   * <p>
   * Note that this is by default just available for JavaMail >= 1.3. You can override the default
   * <code>validateAddress method</code> for validation on older JavaMail versions (or for custom
   * validation).
   * 
   * @see #validateAddress
   */
   ...
   * adders.
   * <p>
   * Default implementation invokes <code>InternetAddress.validate()</code>, provided that address
   * validation is activated for the helper instance.
   * <p>
   * Note that this method will just work on JavaMail >= 1.3. You can override it for validation on
   * older JavaMail versions or for custom validation.
   * 
   ...
   * <p>
   * <b>NOTE:</b> Invoke {@link #addInline} <i>after</i> <code>setText</code>; else, mail readers
   ...
   * <p>
   * Note that the InputStream returned by the DataSource implementation needs to be a <i>fresh one
   * on each call</i>, as JavaMail will invoke <code>getInputStream()</code> multiple times.
   * <p>
   * <b>NOTE:</b> Invoke <code>addInline</code> <i>after</i> {@link #setText}; else, mail readers
   * might not be able to resolve inline references correctly.
   * 
   ...
   * @param dataSource the <code>javax.activation.DataSource</code> to take the content from,
  ...
  /**
   * Add an inline element to the MimeMessage, taking the content from a <code>java.io.File</code>.
   * <p>
   * The content type will be determined by the name of the given content file. Do not use this for
   * temporary files with arbitrary filenames (possibly ending in ".tmp" or the like)!
   * <p>
   * <b>NOTE:</b> Invoke <code>addInline</code> <i>after</i> {@link #setText}; else, mail readers
   * might not be able to resolve inline references correctly.
   * 
  ...
  /**
   * Add an attachment to the MimeMessage, taking the content from a <code>java.io.File</code>.
   * <p>
   * The content type will be determined by the name of the given content file. Do not use this for
   * temporary files with arbitrary filenames (possibly ending in ".tmp" or the like)!
   * 
