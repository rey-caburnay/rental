...
public class StringUtil {
  ...
  /**
   * dd-MMM-yyyy { 7-Jun-2013 } dd/MM/yyyy { 07/06/2013 } MMM dd, yyyy { Jun 7, 2013 } E, MMM dd
   * yyyy { Fri, June 7 2013 } EEEE, MMM dd, yyyy HH:mm:ss a { Friday, Jun 7, 2013 12:10:56 PM }
   * 
   * @param dateString
   * @param format
   * @return
