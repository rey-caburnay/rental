...
public class RentStatus {
    ...
    public static String RECEIPT_RENT_MESSAGE = "Thank you for paying your rent with the amount of {amount}. Reference # {reference}";
    public static String RECEIPT_GENERIC_PAYMENT_MESSAGE = "Thank you for paying your rent. This will also serve as your receipt";
