...
public class NamedParameterStatement {
    ...
    public NamedParameterStatement(Connection connection, String query, int autGeneratedKeys) throws SQLException {
        indexMap = new HashMap<>();
        String parsedQuery = parse(query, indexMap);
        statement = connection.prepareStatement(parsedQuery,autGeneratedKeys);
    }
     ...
     * the parsed query is returned. DO NOT CALL FROM CLIENT CODE. This method is non-private so
     * JUnit code can test it.
     * 
